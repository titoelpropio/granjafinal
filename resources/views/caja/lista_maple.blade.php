...
<!--table  class="table-striped table-bordered table-condensed table-hover" style="width: 100%"-->
    ...
    <thead bgcolor=black style="color: white">
        <th width="365"><center>TIPO DE CAJA</center></th>
        <th width="365"><center>CANTIDAD DE MAPLES</center></th>
        <th width="365"><center>CANTIDAD DE HUEVOS</center></th>
        <th width="365"><center>FECHA</center></th>
    </thead>
</table>
